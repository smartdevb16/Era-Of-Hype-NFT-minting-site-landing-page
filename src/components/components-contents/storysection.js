                ...
                <div className="w-5/6 grid grid-cols-2 gap-8">
                    ...
                    <div className="flex flex-col justify-center space-y-5">
                        ...
                        <p className="text-white text-xl">
                            An <strong>immensely rare intergalactic phenomenon</strong> called the space-time rift propelled the planet « Clout » located 13 light years from planet Earth into a black nebula.<br></br>This three-dimensional Miracle <strong>linked the Metaverse by teleporting hordes of legendary creatures</strong>. Ahead by 4000 years, they have more knowledge at all levels, <strong>it is the Era of Hype</strong>.
                        </p>
                    </div>
                </div>
